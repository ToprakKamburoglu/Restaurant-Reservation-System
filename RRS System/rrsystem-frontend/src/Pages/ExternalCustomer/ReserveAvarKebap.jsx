...
import AvarHeader from "./AvarHeader.jsx";
import AvarFooter from "./AvarFooter.jsx";
...
const ReserveIzaka = ({ hideHeaderFooter = false }) => {
  ...
  const apiKey = "ppB20vJMnfICHhnMQfi4xmolIcSg47rN1aP9j0nrym1rmggQa2p1Fk8BZVxGr9Km";
  ...
  return (
    <>
      {!hideHeaderFooter && <AvarHeader />}
      {message.text && (
        <div className={`alert ${message.type} mt-4 m-3 p-3`}>{message.text}</div>
      )}
      <div className="booking-content avar-kebap">
