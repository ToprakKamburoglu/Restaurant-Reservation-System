...
function UpdatePersonel() {
    ...
    useEffect(() => {
        fetch("http://localhost:8081/api/manager/user-info/get-info", {
            method: "GET",
            credentials: "include",
        })
    ...
    const handleSubmit = (event) => {
        ...
        fetch("http://localhost:8081/api/manager/user-info/update-user-info", {
            method: "PUT",
            headers: {
    ...
    const handlePhotoUpload = (e) => {
        ...
        fetch("http://localhost:8081/api/manager/user-info/upload-photo", {
            method: "POST",
            credentials: "include",
            body: formData,
        })
