...
public interface AddSessionRepository extends JpaRepository<SessionInfo, Long> {
    ...
    boolean existsByRestaurantAndSessionDateAndSessionStartAndSessionActiveness(
            RestaurantInfo restaurant, Date sessionDate, LocalTime sessionStart, int sessionActiveness);
}