...
public class RestaurantInfo {
    ...
    @Column(name = "restaurant_service_status")
    private int restaurantServiceStatus;
    ...
    public int getRestaurantServiceStatus() {
        return restaurantServiceStatus;
    }

    public void setRestaurantServiceStatus(int restaurantServiceStatus) {
        this.restaurantServiceStatus = restaurantServiceStatus;
    }
