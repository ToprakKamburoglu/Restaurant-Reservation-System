...
public class SessionInfo {
    ...
    @Column(name = "is_checked_by_system")
    private int isCheckedBySystem;
    ...
    public int getIsCheckedBySystem() {
        return isCheckedBySystem;
    }

    public void setIsCheckedBySystem(int isCheckedBySystem) {
        this.isCheckedBySystem = isCheckedBySystem;
    }
